...
@section('title', $category->title  .  'Arts')
@section('content')
<div class="page-title wb">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-paint-brush"></i> {{$category->title}} <small class="hidden-xs-down hidden-sm-down"> {{$category->description}} </small></h2>
                    </div><!-- end col -->                  
                </div><!-- end row -->
            </div><!-- end container -->
        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="blog-box">
                                            ...
                                            <div class="blog-meta big-meta">
                                                ...
                                                <p>{{$rs->description}}</p>
                                                <a href="blog-category-01.html" title="">{{$rs->category->title}} /</a>
