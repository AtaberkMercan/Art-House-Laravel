    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-12">
                <h3>{{$art->title}}</h3>
                <hr>
                <form  role="form" action="{{route('image.store',['pid'=>$art->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                                ...
                                <table class="table table-bordered">
                                    ...
                                    @foreach($images as $rs)
                                        <tr>
                                            ...
                                            <td><a href="{{route('image.destroy',['pid'=>$art->id,'id'=>$rs->id])}}"><button type="button" class="btn btn-danger btn-fw" onclick="return confirm('Are you sure to delete this category?')">Delete</button> </a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
